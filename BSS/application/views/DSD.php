          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3 style="display: inline-block;">District Secretariats </h3>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo base_url() ?>DSD_Controller/save">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="ds-name">DS Name<span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input name="ds" type="text" id="ds-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <?php foreach($dsd as $d) {?>
                        <tr>
                          ...
                          <?= form_open('DSD_Controller/delete',array('class' => 'delete','method'=>'post')); ?>
                          ...
                          <div style="display: inline-block;">
                            <?= form_open('DSD_Controller/edit',array('class' => 'edit','method'=>'post')); ?>
                            <input type="hidden" name="id" value="<?php echo $d->ID; ?>">
