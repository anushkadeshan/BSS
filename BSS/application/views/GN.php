          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3 style="display: inline-block;">Grama Niladhari Office </h3>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo base_url() ?>GN_Controller/save">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="ds-name">GN Office Name<span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input name="gn" type="text" id="ds-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                       <?php foreach($gn as $g){ ?>
                        <tr>
                          <td><?php echo $g->GN_ID ?></td>
                          <td style="max-width:165px;"><?php echo $g->GN_Office ?></td>
                          <td><?php echo $g->DSD_Name; ?></td>
                          <td><?php echo $g->District; ?></td>
                          <td><?php echo $g->Province; ?></td>
                          <td><?php echo $g->timestamp_gn; ?></td>
                          <td style="min-width: 135px;max-width:135px;">
                          <div style="display: inline-block;">
                          <?= form_open('GN_Controller/delete',array('class' => 'delete','method'=>'post')); ?>
                          ...
                          <div style="display: inline-block;">
                            <?= form_open('GN_Controller/edit',array('class' => 'edit','method'=>'post')); ?>
                            <input type="hidden" name="id" value="<?php echo $g->GN_ID; ?>">
