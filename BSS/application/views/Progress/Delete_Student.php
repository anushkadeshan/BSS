					...
					<div class="">
						<div class="page-title">
							<div class="title_left">
								...
								<a href="<?php echo base_url() ?>Student_Controller/n_student"><button type="submit" class="btn btn-primary">Add New</button></a>
							</div>
						</div>
					</div>
					<!-- Modal -->
...
<div class="row">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
										...
										<table id="datatable-buttons" class="table table-striped table-bordered">
											...
											<?php foreach($student as $s){ ?>
												<tr>
													...
													<td><a href="<?php echo base_url()?>Student_Controller/delete/<?php echo $s->ST_ID; ?>"><button type="submit" data-toggle="confirmation"
                                ...
                                data-title="This Action will delete student all data. You cannot recover again. Are You Sure? "   class="btn btn-danger"><i class="fa fa-remove" ></i> Delete</button></a></td>
