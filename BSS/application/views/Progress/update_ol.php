                   ...
                   switch ($status) {
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                              <input placeholder="Stream"  type="text" id="first-name" required="required" name="stream1" class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="form-group">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                              <input placeholder="Exam Year" data-parsley-type="integer" required="required" type="text" id="first-name" name="year1" class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="form-group">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                              <input placeholder="Index Number" data-parsley-type="integer" required="required" type="text" id="first-name" name="index1" class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                              <input placeholder="Stream"  type="text" id="stream2" name="stream2" class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="form-group">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                              <input placeholder="Exam Year" data-parsley-type="integer"  type="text" id="year2" name="year2" class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="form-group">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                             <textarea placeholder="Reasons for Dropouts" class="form-control col-md-7 col-xs-12" id="dropouts" name="dropout"  rows="4"></textarea>
