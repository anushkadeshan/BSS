                ...
                <div class="x_panel">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="form-group">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                            <label>Exam Year</label>
                              <input placeholder="Exam Year" value="<?php echo $al->Year ?>" data-parsley-minlength="4" data-parsley-type="integer" required="required" type="text" id="first-name" name="year1" class="form-control col-md-7 col-xs-12">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="form-group">
                            ...
                            <label>Pass / Fail</label>
                            <select class="form-control" id="pass1" name="pass1" required="required">
                            <option <?php if(is_null($al->Pass_Fail)){?> selected="selected" <?php }?> value="">Pass / Fail </option>
