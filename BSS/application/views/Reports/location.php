				...
				<div class="right_col" role="main">
					<div class="">
						<div>
							<div>
								<div class="row">
										<form data-parsley-validate id="myForm" action="<?php echo base_url() ?>Reports_Controller/location" method="post" >
											
											<div class="col-md-4 col-sm-4 col-xs-12">
											<label style="display:inline-block;"> Select DS Office :</label>
											<select style="display:inline-block;" class="form-control" id="ds" name="dsd" required="required" >
											<option value="">Select a DS Office</option>
											<?php foreach($dsd as $ds){ ?>
											<option value="<?php echo $ds->ID?>"><?php echo $ds->DSD_Name?></option>
											<?php } ?>
											</select>
											</div>
											<div class="col-md-4 col-sm-4 col-xs-12">
											<label style="display:inline-block;"> Select GN Office :</label>
											<select style="display:inline-block;" class="form-control" name="gn" id="gn">
											...
											<a href="<?php echo base_url() ?>Reports_Controller/location" ><input id="refresh" style="display:inline-block;" type="button" value="Refresh" class="btn btn-primary"></a>
											</div>
	...
	jQuery(document).ready(function(){
      $("#ds").change(function() {
        $.ajax({
		  ...
		  $("#gn").html("");
		  $('#gn').append("<option value=''> All </option>");
...
<script>
	function getData(){
        $.ajax({
          type: "POST",
          data: $('#myForm').serialize(),
          url: "<?= base_url() ?>Reports_Controller/location",
