				...
				<div class="right_col" role="main">
					<div class="">
						<div>
							<div>
								<div class="row">
										<form data-parsley-validate id="myForm" action="<?php echo base_url() ?>Reports_Controller/branch" method="post" >
											
											<div class="col-md-4 col-sm-4 col-xs-12">
											<label style="display:inline-block;"> Select Branch :</label>
