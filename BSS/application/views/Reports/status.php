				...
				<div class="right_col" role="main">
					<div class="">
						<div>
							<div>
								<div class="row">
										<form data-parsley-validate id="myForm" action="<?php echo base_url() ?>Reports_Controller/status" method="post" >
											
											<div class="col-md-4 col-sm-4 col-xs-12">
											<label style="display:inline-block;"> Select Current Status :</label>
											...
											<a href="<?php echo base_url() ?>Reports_Controller/status" ><input id="refresh" style="display:inline-block;" type="button" value="Refresh" class="btn btn-primary"></a>
											</div>
